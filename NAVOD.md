...
Tvůj web **pustelnikcoach.vercel.app** si můžeš měnit úplně sám — texty, ceny, fotky,
...
Otevři **https://pustelnikcoach.vercel.app**, dej **Cmd + R** (obnovit) a koukni, jestli tam změna je.
...
nezmění. Kdybys přesto něco z toho potřeboval upravit, **napiš Lukovi**, ne Claudovi.
...
nebo si v čemkoliv nejsi jistý, **napiš Lukovi (Web by Luke Přibyla)**. Spraví to.
